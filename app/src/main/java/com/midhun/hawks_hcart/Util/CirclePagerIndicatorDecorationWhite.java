...
public class CirclePagerIndicatorDecorationWhite extends RecyclerView.ItemDecoration {
    private int colorActive = 0xFFFFFFFF;
    private int colorInactive = 0xDEdddddd;
    ...
    public CirclePagerIndicatorDecorationWhite() {
